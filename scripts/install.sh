...
run_or_fail "Could not download OpenBankingMCP. Check your internet connection, then run the installer again." git clone --depth 1 "$REPOSITORY" "$APP_DIR"
[ -f "$APP_DIR/web/dist/index.html" ] || fail "The downloaded release is missing dashboard assets. Use a published release of OpenBankingMCP."
...
printf '\nOpenBankingMCP is installed and running locally.\n\n'
